  ...
  <div class="flex flex-col min-h-screen">
    <header class="p-4 border-b shadow-sm fixed w-full z-10 bg-white flex items-center sm:justify-between lg:justify-around">
      <NuxtLink to="/" class="font-mono font-bold text-2xl text-gray-800 no-underline hover:text-gray-800">
        <div><img src="/icon.png" width="32" height="32" style="float: left; margin-right: 8px;" /> eggnstone.com</div>
      </NuxtLink>
      <search-box />
    </header>
...
<!--
      <a href="https://twitter.com/" target="_blank" class="h-6 w-6 ml-2">
      ...
      <a href="https://www.linkedin.com/in/" target="_blank" class="h-6 w-6 ml-2">
        <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
      ...
      <a href="mailto:@gmail.com" target="_blank" class="h-6 w-6 ml-2">
        <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
